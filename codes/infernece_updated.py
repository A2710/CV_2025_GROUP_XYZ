...
def prepare_calibration_data(dataset_path: str, batch_size: int, input_shape: Tuple, num_batches: int = 10) -> np.ndarray:
    ...
    """
    csv_path = "/media/seas_au/prsdata/xyz/cv final/ICFG-PDES/ICFG-PEDES/captions_cleaned_local.csv"
...
def run_inference(engine: trt.ICudaEngine, input_data: np.ndarray) -> List[np.ndarray]:
    ...
    with engine.create_execution_context() as context:
        ...
        for i in range(engine.num_bindings):
            ...
            d_output = cuda.mem_alloc(output_size * output_dtype.itemsize)
...
def main():
    ...
    onnx_model_path = "/media/seas_au/prsdata/xyz/cv final/ICFG-PDES/ICFG-PEDES/final_model.onnx"  # Update with your actual ONNX path
    engine_path = "/media/seas_au/prsdata/xyz/cv final/ICFG-PDES/ICFG-PEDES/final_modelfp16.engine"
    ...
    if precision == "int8":
        calibration_data = prepare_calibration_data(
            dataset_path="/media/seas_au/prsdata/xyz/cv final/ICFG-PDES/ICFG-PEDES",
